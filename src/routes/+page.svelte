<script>
 ...
 // **** Scale for bubble size
  ...
  <div class="div-block-11">
    <a id="1" on:mouseenter={() => mouseEnterTitle(1)} on:mouseleave={mouseLeaveTitle} class="linkBottom" href="phase1"><h1 class="heading bottom">phase one</h1></a>
    ...
    <div bind:clientWidth={w} bind:clientHeight={h} class="main-viz">
      ...
      <div class="div-block-10 main"  style="background-image: url('./images/all.png')"/>    
